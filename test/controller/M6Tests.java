 ...
 */
public class M6Tests extends ApplicationTest {
    private Stage stage;
    ...
    public void testGoToGameScreenWithLevelEasyAndShouldHaveTowerCostForTheLevel()
        ...
        Pane vertex = (Pane) stage.getScene().lookup("#game-screen-tower-vertex-id-4");
        clickOn(vertex);
    ...
    public void testGoToGameScreenWithLevelMediumAndShouldHaveTowerCostForTheLevel()
        ...
        // click a tower vertex
        Pane vertex = (Pane) stage.getScene().lookup("#game-screen-tower-vertex-id-5");
        clickOn(vertex);
