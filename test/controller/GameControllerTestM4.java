 ...
 */
public class GameControllerTestM4 extends ApplicationTest {
    private Stage stage;
     ...
     */
    @Test
    public void testGoToGameScreenWithLevelEasyHaveTowerCostForTheLevel()
     ...
     */
    @Test
    public void testGoToGameScreenWithLevelMediumHaveTowerCostForTheLevel()
            throws InterruptedException {
        clickOn("Start");
        clickOn("Name...");
        type(KeyCode.A, KeyCode.B, KeyCode.C, KeyCode.D);
